...
import multimodule.missioncontrol.service.PatientService;
...
@Component
public class MissionControlPatientEventListener {
    ...
    public void onPatientCreated(PatientCreatedEvent patientCreatedEvent) {
        Patient patient = Patient.builder()
                .phoneNumber(patientCreatedEvent.getPhoneNumber())
    ...
    public void onPatientUpdated(PatientUpdatedEvent patientUpdatedEvent) {
        Patient patient = Patient.builder()
                ...
                .phoneNumber(patientUpdatedEvent.getPhoneNumber())
                .build();
